...
@ContentView(value = R.layout.junhengqi)
public class JunHengQiActivity extends BaseActivity {
	...
	@ViewInject(value = R.id.sb_junheng0)
	private SeekBar sb_junheng0;
	@ViewInject(value = R.id.tv_junheng0)
	private TextView tv_junheng0;

	@ViewInject(value = R.id.sb_junheng9)
	private SeekBar sb_junheng9;
	@ViewInject(value = R.id.tv_eq9)
	private TextView tv_junheng9;
